    ...
    <main>
      ...
      <section id="ingredient-dm" class="card">
        ...
        <div class="grid cols-2">
          ...
          <div>
            <div class="toolbar" style="margin-top:8px">
              <a class="yt-btn" href="https://www.canva.com/design/DAG_MVRJ3Jc/0TbREbO-tVXqDGb5XuUDQw/edit?utm_content=DAG_MVRJ3Jc&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" target="_blank" rel="noopener">
                <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M8 5v14l11-7z"/></svg>
                Watch demo
              </a>
            </div>
      ...
      <div class="footer">© 2025 GMH × UCD — Practical guide.</div>
    </main>
  </div>
